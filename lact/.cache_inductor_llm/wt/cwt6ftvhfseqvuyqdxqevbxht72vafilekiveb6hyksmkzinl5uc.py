...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/26/c262lae3e3iie2yg2acfm3v2z5arxrnlzfrzye6apjilzdfht5kw.py
...
#   %slice_1 : Tensor "f32[32, 1024, 192][786432, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_7, 1, 0, 1024), kwargs = {})
...
#   %permute_3 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%slice_1, [0, 2, 1]), kwargs = {})
#   %convert_element_type_13 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_3, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_29 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_11, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_32 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_12, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/qr/cqrjza5ymyl6c355k4fpxeq7lpjo34iahljntguq636jfcj7q4l2.py
...
#   %pow_3 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%primals_2, 2), kwargs = {})
...
#   %pow_4 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_2, 0.5), kwargs = {})
#   %convert_element_type_10 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_2, torch.bfloat16), kwargs = {})
#   %permute_5 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%primals_2, [0, 2, 1]), kwargs = {})
#   %convert_element_type_21 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_5, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/mf/cmfm6ngxd3rtijft3qugf4ohe6ptu6j6ldghxqarh6tix3namnn2.py
...
#   %convert_element_type_20 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_2, torch.bfloat16), kwargs = {})
...
#   %mul_5 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_5, %convert_element_type_20), kwargs = {})
...
#   %mul_9 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %add), kwargs = {})
...
#   %convert_element_type_26 : Tensor "bf16[32, 1024, 192][196608, 1, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_10, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/pd/cpdbkhhkz4po6mefpog5eesqg4ywv6uajuam6vtpaobbl46ugkpo.py
# Topologically Sorted Source Nodes: [m_i, m_i_1], Original ATen: [aten.slice, aten.mean]
# Source node to ATen node mapping:
#   m_i => slice_10
#   m_i_1 => mean
# Graph fragment:
#   %primals_4 : Tensor "f32[32, 4096, 1][4096, 1, 1]cuda:0" = PlaceHolder[target=primals_4]
#   %buf25 : Tensor "f32[32, 1, 1][1, 32, 32]cuda:0" = PlaceHolder[target=buf25]
#   %slice_10 : Tensor "f32[32, 1024, 1][4096, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_4, 1, 0, 1024), kwargs = {})
#   %mean : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%slice_10, [1], True), kwargs = {})
#   return %buf25,%mean
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/vi/cvi2tsmocgcclywk6szlw6vjegdl4rlayqsjtf4btkwpf3mze4un.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/em/cem2lkmff7tcxgmmiyo4i3cws2yr6ubkdx4gnnx2qsq34axjy6b3.py
...
# Graph fragment:
#   %buf66 : Tensor "f32[32, 1, 1, 5][5, 160, 160, 1]cuda:0" = PlaceHolder[target=buf66]
...
#   %pow_9 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_83, 2), kwargs = {})
#   %sum_5 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_9, [1, 2], True), kwargs = {})
#   %pow_10 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_5, 0.5), kwargs = {})
#   return %sum_5,%pow_10
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/t4/ct4bvrkjercef2fdvohoivdgc6sfbbyt7tuwlesdhtjwphnagg4r.py
...
#   %div : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_35, %add_4), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/ou/coucvklyycmmd3gnnvzqstpn6hbl56th2gvua5bjepg4ybb25asm.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/vh/cvhhtl4suwtygxazfmkwjvr2blth7kkzrilee737iy76gwlhsgla.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/wg/cwgkulmvvb2ba74vd3whzsmhelspki5ot3kj26qp6hlu666fi74j.py
...
#   %add_6 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_18, %bmm_11), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/y4/cy4fgq7kfa6qbbvsl47jwmtrgemvexzcfo4kdmsfn53ffo5ioeif.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/og/cogsnl2qnjmfta77bwahych3iwuju74romcden4jtejg3l3ja66b.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/nk/cnki5r7y5bkk56c2s44xwv3bipgm5xetk5mxon5h6tu4ekcbfjkg.py
...
#   %add_8 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_21, %bmm_14), kwargs = {})
...
#   %div_1 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_82, %add_15), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/dl/cdlrkeduhsv3rdn5l3a7hhlbr6fxwdf3atfdxcei27axg4r3hxd2.py
...
#   %mul_13 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%full_default_1, %mean), kwargs = {})
#   %add_1 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%bmm_7, %mul_13), kwargs = {})
#   %add_3 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%bmm_8, %mul_13), kwargs = {})
#   %convert_element_type_82 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
#   %add_15 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%pow_10, 1e-07), kwargs = {})
#   %div_1 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_82, %add_15), kwargs = {})
#   %mul_33 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_1, 4.0848), kwargs = {})
#   %add_17 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_33, %bmm_26), kwargs = {})
#   %mul_36 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_17, 3.9505), kwargs = {})
#   %add_19 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_36, %bmm_29), kwargs = {})
#   %permute_14 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_19, [0, 2, 1]), kwargs = {})
#   %convert_element_type_102 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_14, torch.bfloat16), kwargs = {})
#   %convert_element_type_103 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_19, torch.bfloat16), kwargs = {})
#   %convert_element_type_129 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/xw/cxwv4lfr2rlcok53ptzh5tginnnd42wbg7qe75ralrhod3w36c6j.py
# Topologically Sorted Source Nodes: [mul_35], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#   mul_35 => mul_38
# Graph fragment:
#   %expand_45 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_45]
#   %mul_38 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_30, 2.3037), kwargs = {})
#   return %expand_44
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/sq/csq6tgz2ayc7vgxtrpdvhqobbtqkr2ql24hz22laqiz5hdrmscsn.py
...
# Graph fragment:
#   %expand_45 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_45]
#   %bmm_31 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=bmm_31]
#   %mul_37 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_30, -5.5913), kwargs = {})
#   %add_20 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_37, %bmm_31), kwargs = {})
#   return %expand_46
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/4v/c4vqnspdn66hhgmbo6ilavnwfypkqpg6cv3b5w57lagrfhvttezv.py
...
#   %add_21 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_39, %bmm_32), kwargs = {})
#   %permute_15 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_21, [0, 2, 1]), kwargs = {})
#   %convert_element_type_111 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_15, torch.bfloat16), kwargs = {})
#   %convert_element_type_112 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_21, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/yk/cykcsklucnvivdfltbnsk7dcsompo7vvm55jvyef5hec2olpf242.py
# Topologically Sorted Source Nodes: [mul_38], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#   mul_38 => mul_41
# Graph fragment:
#   %expand_51 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_51]
#   %mul_41 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_33, 1.2046), kwargs = {})
#   return %expand_50
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/td/ctdfu3xzgd765tuat6hcizpwnvcab4ux7qdpn6n6z3os5cmwstie.py
...
# Graph fragment:
#   %expand_51 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_51]
#   %bmm_34 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=bmm_34]
#   %mul_40 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_33, -3.1427), kwargs = {})
#   %add_22 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_40, %bmm_34), kwargs = {})
#   return %expand_52
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/sh/csh4hmh7mgnrn6xk5rw635kj4mfkbwf66zmqcwh4lpf47b2eoedf.py
...
#   %add_23 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_42, %bmm_35), kwargs = {})
#   %permute_16 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_23, [0, 2, 1]), kwargs = {})
#   %convert_element_type_120 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_16, torch.bfloat16), kwargs = {})
#   %convert_element_type_121 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_23, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/xv/cxvlyset6qrdb3almnlbzkm27aum4wuhhxsc6j74igzq6iyoolrk.py
# Topologically Sorted Source Nodes: [mul_41], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#   mul_41 => mul_44
# Graph fragment:
#   %expand_57 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_57]
#   %mul_44 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_36, 1.2012), kwargs = {})
#   return %expand_56
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/pn/cpnabefpxslqbr5dogfnucr7tjx3redwxx5rvmf5xlurn2ulzdzm.py
...
# Graph fragment:
#   %expand_57 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=expand_57]
#   %bmm_37 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=bmm_37]
#   %mul_43 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_36, -3.0525), kwargs = {})
#   %add_24 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_43, %bmm_37), kwargs = {})
#   return %expand_58
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/uf/cuftsmrr5izsr23hjk2bsfvmizqoxkcku6xbplb5zhyoxp36hurt.py
...
# Graph fragment:
#   %primals_1 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=primals_1]
...
#   %pow_14 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_14]
#   %pow_2 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_2]
#   %convert_element_type : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_1, torch.float32), kwargs = {})
...
#   %pow_2 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_1, 0.5), kwargs = {})
#   %mul_39 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, 3.7418), kwargs = {})
#   %add_21 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_39, %bmm_32), kwargs = {})
#   %mul_42 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_21, 2.8769), kwargs = {})
#   %add_23 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_42, %bmm_35), kwargs = {})
...
#   %add_38 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %add_25), kwargs = {})
...
#   %pow_14 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_7, 0.5), kwargs = {})
...
#   %mul_61 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_3, %pow_2), kwargs = {})
#   %convert_element_type_181 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_61, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/yc/cycalyybtiklmyiirj6vx3vfkiqiixxy35rp52zwgmhlizrpa236.py
...
# Graph fragment:
#   %convert_element_type_129 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=convert_element_type_129]
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/qd/cqdwttrbkmzxw564ev2tboyygwpvlqllnt7574l67qwweyijgo3d.py
...
# Graph fragment:
#   %convert_element_type_129 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=convert_element_type_129]
#   %pow_12 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0" = PlaceHolder[target=pow_12]
...
#   %div_2 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_129, %add_26), kwargs = {})
...
#   %convert_element_type_131 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_17, torch.bfloat16), kwargs = {})
#   %convert_element_type_132 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_2, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/cp/ccpdjkma427vqmq3pkattjo4es4launv3qog2grmajhcvbwlxupc.py
...
#   %add_28 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_48, %bmm_41), kwargs = {})
#   %permute_18 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_28, [0, 2, 1]), kwargs = {})
#   %convert_element_type_140 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_18, torch.bfloat16), kwargs = {})
#   %convert_element_type_141 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_28, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/ll/cllzcjbimqvl7u5djxrf6qyt6c4shwvbnip63ryzmdz65jvjcegx.py
...
#   %add_30 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_51, %bmm_44), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/rq/crqrk7ub7ckctu7bncclwchgvsxn33dlk74r77k7n5xamew6hio5.py
...
#   %add_32 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=add_32]
#   %add_26 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%pow_12, 1e-07), kwargs = {})
#   %div_2 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_129, %add_26), kwargs = {})
#   %mul_48 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, 4.0848), kwargs = {})
#   %add_28 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_48, %bmm_41), kwargs = {})
...
#   %add_32 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_54, %bmm_47), kwargs = {})
#   %permute_20 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_32, [0, 2, 1]), kwargs = {})
#   %convert_element_type_158 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_20, torch.bfloat16), kwargs = {})
#   %convert_element_type_159 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_32, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/rz/crzltarrgqjzeuw45yhnmttdvabih3xhzje3fn5ynupkcng5yxar.py
...
#   %add_34 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_57, %bmm_50), kwargs = {})
#   %permute_21 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_34, [0, 2, 1]), kwargs = {})
#   %convert_element_type_167 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_21, torch.bfloat16), kwargs = {})
#   %convert_element_type_168 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_34, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/xh/cxhvqoymu3tcdh3kvaakoxkkuxh5q2q42k6phfrqz7ea3wngyukj.py
...
#   %pow_18 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_18]
#   %pow_6 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_6]
#   %convert_element_type_1 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_3, torch.float32), kwargs = {})
...
#   %pow_6 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_3, 0.5), kwargs = {})
#   %mul_57 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_32, 2.8769), kwargs = {})
#   %add_34 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_57, %bmm_50), kwargs = {})
...
#   %add_39 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_3, %add_36), kwargs = {})
...
#   %pow_18 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_9, 0.5), kwargs = {})
...
#   %mul_63 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_5, %pow_6), kwargs = {})
#   %convert_element_type_177 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_63, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/un/cun4dg5bsqaj3pdot5wia6752ojanqexzhtd272u4fzj34pqkgo3.py
...
#   qi => slice_3
# Graph fragment:
#   %primals_5 : Tensor "f32[32, 4096, 192][786432, 192, 1]cuda:0" = PlaceHolder[target=primals_5]
#   %permute : Tensor "f32[32, 192, 4096][786432, 1, 192]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.permute.default](args = (%primals_5, [0, 2, 1]), kwargs = {})
#   %slice_3 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%permute, 2, 0, 1024), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_3, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/j6/cj6kgqjqebmwlappl4yul3uv7wb2fzof6hmuuyet3txw3pq2afxn.py
...
#   %mul_1 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_9, %bmm), kwargs = {})
#   return %mul_1
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/n6/cn6qgzzirp6jye7mcpwwndarg4piww3uo4oftaljqv5n2xjofnzy.py
...
#   %pow_16 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_16]
...
#   %add_10 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_24, %bmm_17), kwargs = {})
...
#   %add_12 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_27, %bmm_20), kwargs = {})
...
#   %add_37 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_2, %add_14), kwargs = {})
...
#   %pow_16 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_8, 0.5), kwargs = {})
...
#   %convert_element_type_186 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_62, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_199 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_24, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/27/c27zazcuuu52v3gdqpxv7tk73wb5v7pgsvdlb4sl5mb2tn3ox4hb.py
...
#   %primals_5 : Tensor "f32[32, 4096, 192][786432, 192, 1]cuda:0" = PlaceHolder[target=primals_5]
#   %permute : Tensor "f32[32, 192, 4096][786432, 1, 192]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.permute.default](args = (%primals_5, [0, 2, 1]), kwargs = {})
#   %slice_13 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%permute, 2, 1024, 2048), kwargs = {})
#   %convert_element_type_176 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_13, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/kn/ckn5jlxqkhsevnvehpqdebmk5momifgbyw7guhkihfttetmtue2c.py
...
#   %primals_10 : Tensor "f32[32, 4096, 1][12288, 3, 1]cuda:0" = PlaceHolder[target=primals_10]
#   %primals_9 : Tensor "f32[32, 4096, 1][12288, 3, 1]cuda:0" = PlaceHolder[target=primals_9]
#   %slice_11 : Tensor "f32[32, 1024, 192][786432, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_7, 1, 1024, 2048), kwargs = {})
...
#   %permute_22 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%slice_11, [0, 2, 1]), kwargs = {})
#   %convert_element_type_189 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_22, torch.bfloat16), kwargs = {})
#   %mul_75 : Tensor "f32[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_11, %slice_16), kwargs = {})
#   %convert_element_type_207 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_75, torch.bfloat16), kwargs = {})
#   %mul_76 : Tensor "f32[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_11, %slice_15), kwargs = {})
#   %convert_element_type_210 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_76, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/wc/cwcbmzos4ijzc5vj5gc7ftwdmpxzjwhmuvafp73n3ys5uk7lspny.py
...
#   %convert_element_type_198 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_66, torch.bfloat16), kwargs = {})
...
#   %mul_69 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_59, %convert_element_type_198), kwargs = {})
...
#   %mul_73 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_71, %add_43), kwargs = {})
...
#   %mul_74 : Tensor "f32[32, 1024, 192][196608, 1, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_25, %slice_14), kwargs = {})
#   %convert_element_type_204 : Tensor "bf16[32, 1024, 192][196608, 1, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_74, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/aa/caalhgahm3rbx6pn2wr2ardw6p2xczn37qs3hd5kuk7wugmvxox7.py
...
# Graph fragment:
#   %primals_4 : Tensor "f32[32, 4096, 1][4096, 1, 1]cuda:0" = PlaceHolder[target=primals_4]
#   %buf175 : Tensor "f32[32, 1, 1][1, 32, 32]cuda:0" = PlaceHolder[target=buf175]
#   %slice_21 : Tensor "f32[32, 1024, 1][4096, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_4, 1, 1024, 2048), kwargs = {})
#   %mean_1 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%slice_21, [1], True), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/73/c73ddhbkcxj3agqcwnr5cloephktkb5mzv43h47rh5brpaix2jvw.py
...
#   %add_44 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%bmm_61, %mul_77), kwargs = {})
#   return %add_44
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/ob/cobr5xww3w34yc4wl4vyaji2nsmuafgvxymqvsjmqgyrpevfbebi.py
...
#   %add_46 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%bmm_62, %mul_79), kwargs = {})
#   %convert_element_type_307 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_46, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/jz/cjzy2gmakibchahiobmnfqlaag43kibcztwwsab7d4upqebavvat.py
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/ca/ccaz7kgaljmxd3lpalku3ujrjdsdervloychzmt3e6xmpxhmbye2.py
...
#   %div_6 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_213, %add_47), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/hv/chvsxizddttoy47arplfhts2tk4h22kagsqey7v5draxsfqt3val.py
...
#   %add_47 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%pow_20, 1e-07), kwargs = {})
#   %div_6 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_213, %add_47), kwargs = {})
#   %mul_82 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_6, 4.0848), kwargs = {})
#   %add_49 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_82, %bmm_65), kwargs = {})
#   %permute_27 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_49, [0, 2, 1]), kwargs = {})
#   %convert_element_type_224 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_27, torch.bfloat16), kwargs = {})
#   %convert_element_type_225 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_49, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/wx/cwxpvxj2bztsn2k7s5ag5sxcd5i7uaw2wuh56kccoranvmshhn3u.py
...
#   %mul_82 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_6, 4.0848), kwargs = {})
#   %add_49 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_82, %bmm_65), kwargs = {})
#   %mul_85 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_49, 3.9505), kwargs = {})
#   %add_51 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_85, %bmm_68), kwargs = {})
#   %permute_28 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_51, [0, 2, 1]), kwargs = {})
#   %convert_element_type_233 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_28, torch.bfloat16), kwargs = {})
#   %convert_element_type_234 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_51, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/px/cpx4otmedlqltf35adyv52cwkgui5svjd7hkbfpklmtb2rasba5l.py
...
#   %add_53 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=add_53]
#   %convert_element_type_213 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_45, torch.bfloat16), kwargs = {})
#   %add_47 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%pow_20, 1e-07), kwargs = {})
#   %div_6 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_213, %add_47), kwargs = {})
#   %mul_82 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_6, 4.0848), kwargs = {})
...
#   %mul_85 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_49, 3.9505), kwargs = {})
#   %add_51 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_85, %bmm_68), kwargs = {})
#   %mul_88 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_51, 3.7418), kwargs = {})
#   %add_53 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_88, %bmm_71), kwargs = {})
#   %permute_29 : Tensor "f32[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%add_53, [0, 2, 1]), kwargs = {})
#   %convert_element_type_242 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_29, torch.bfloat16), kwargs = {})
#   %convert_element_type_243 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_53, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/2h/c2h6rtgpb5rbt2delp4jzxytl5ueudjn7wpfsxwugnsw2tonujon.py
...
#   %pow_4 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_4]
#   %mul_91 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_53, 2.8769), kwargs = {})
#   %add_55 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_91, %bmm_74), kwargs = {})
...
#   %add_80 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_37, %add_57), kwargs = {})
...
#   %pow_28 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_14, 0.5), kwargs = {})
...
#   %convert_element_type_364 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_126, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_377 : Tensor "bf16[32, 192, 192][36864, 1, 192]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_43, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/sh/csh56cito6le6msufmjsjkzjb2ptmwyyx3pshh5e3hjefoa7ucp4.py
...
# Graph fragment:
#   %add_38 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=add_38]
#   %add_64 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=add_64]
#   %bmm_89 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=bmm_89]
#   %bmm_92 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=bmm_92]
#   %add_81 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0" = PlaceHolder[target=add_81]
#   %sum_13 : Tensor "f32[32, 192, 1][192, 1, 6144]cuda:0" = PlaceHolder[target=sum_13]
#   %pow_26 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_26]
#   %pow_2 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0" = PlaceHolder[target=pow_2]
#   %mul_106 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_64, 2.8769), kwargs = {})
#   %add_66 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_106, %bmm_89), kwargs = {})
#   %mul_109 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_66, 2.8366), kwargs = {})
#   %add_68 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_109, %bmm_92), kwargs = {})
#   %add_81 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_38, %add_68), kwargs = {})
#   %pow_25 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_81, 2), kwargs = {})
...
#   %pow_26 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_13, 0.5), kwargs = {})
#   %add_83 : Tensor "f32[32, 192, 1][192, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%pow_26, 1e-05), kwargs = {})
#   %div_9 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add_81, %add_83), kwargs = {})
#   %mul_125 : Tensor "f32[32, 192, 192][36864, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_9, %pow_2), kwargs = {})
#   %convert_element_type_359 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_125, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/jb/cjbssgbb6xvbuckszl7bzsepnckwzgbxqcjhblq34iigzrc4r4uw.py
...
#   %primals_5 : Tensor "f32[32, 4096, 192][786432, 192, 1]cuda:0" = PlaceHolder[target=primals_5]
#   %permute : Tensor "f32[32, 192, 4096][786432, 1, 192]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.permute.default](args = (%primals_5, [0, 2, 1]), kwargs = {})
#   %slice_24 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%permute, 2, 2048, 3072), kwargs = {})
#   %convert_element_type_354 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_24, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/ic/cic2iydjrkj7fto2tu5kdjp5oizruaz4qtxdm2xtkjosyve57522.py
...
#   %primals_10 : Tensor "f32[32, 4096, 1][12288, 3, 1]cuda:0" = PlaceHolder[target=primals_10]
#   %primals_9 : Tensor "f32[32, 4096, 1][12288, 3, 1]cuda:0" = PlaceHolder[target=primals_9]
#   %slice_22 : Tensor "f32[32, 1024, 192][786432, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_7, 1, 2048, 3072), kwargs = {})
...
#   %permute_41 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%slice_22, [0, 2, 1]), kwargs = {})
#   %convert_element_type_367 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%permute_41, torch.bfloat16), kwargs = {})
#   %mul_139 : Tensor "f32[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_22, %slice_27), kwargs = {})
#   %convert_element_type_385 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_139, torch.bfloat16), kwargs = {})
#   %mul_140 : Tensor "f32[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_22, %slice_26), kwargs = {})
#   %convert_element_type_388 : Tensor "bf16[32, 1024, 192][196608, 192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_140, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/2q/c2qnucvmzyow7uwnybn4de6xljzpcpqfigukoingpl54xqc5dymx.py
...
#   %convert_element_type_376 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_130, torch.bfloat16), kwargs = {})
...
#   %mul_133 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_113, %convert_element_type_376), kwargs = {})
...
#   %mul_137 : Tensor "bf16[32, 192, 1024][196608, 1024, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_135, %add_86), kwargs = {})
...
#   %mul_138 : Tensor "f32[32, 1024, 192][196608, 1, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_44, %slice_25), kwargs = {})
#   %convert_element_type_382 : Tensor "bf16[32, 1024, 192][196608, 1, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_138, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/3f/c3fuia7npegetgmwff4jw46kegij7h4ws3kfnce2sggdd7bedguq.py
...
# Graph fragment:
#   %primals_4 : Tensor "f32[32, 4096, 1][4096, 1, 1]cuda:0" = PlaceHolder[target=primals_4]
#   %buf328 : Tensor "f32[32, 1, 1][1, 32, 32]cuda:0" = PlaceHolder[target=buf328]
#   %slice_32 : Tensor "f32[32, 1024, 1][4096, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%primals_4, 1, 2048, 3072), kwargs = {})
#   %mean_2 : Tensor "f32[32, 1, 1][1, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%slice_32, [1], True), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/c7/cc72fdrvokch72ujtjd5m7l7gcsag23mkvzimpeg76hdgl6z7f5b.py
...
#   %convert_element_type_391 : Tensor "bf16[32, 192, 192][36864, 192, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_88, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/vf/cvfksequxt2f6dkyxyo5bxty5nljlz3d5cbjbvxf2yi6triwviid.py
...
#   %primals_5 : Tensor "f32[32, 4096, 192][786432, 192, 1]cuda:0" = PlaceHolder[target=primals_5]
#   %permute : Tensor "f32[32, 192, 4096][786432, 1, 192]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.permute.default](args = (%primals_5, [0, 2, 1]), kwargs = {})
#   %slice_33 : Tensor "f32[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%permute, 2, 3072, 4096), kwargs = {})
#   %convert_element_type_532 : Tensor "bf16[32, 192, 1024][196608, 1, 192]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_33, torch.bfloat16), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/v3/cv37t752emr5kpd5ewdeihl6kyu5lcnv6nl2rg7evovuoojqslgp.py
...
#   %slice_18 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%slice_scatter_default, 2, 1024, 2048), kwargs = {})
#   %copy_1 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_18, %bmm_56), kwargs = {})
...
#   %slice_29 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%slice_scatter_default_1, 2, 2048, 3072), kwargs = {})
#   %copy_2 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_29, %bmm_110), kwargs = {})
...
#   %slice_35 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%slice_scatter_default_2, 2, 3072, 4096), kwargs = {})
#   %copy_3 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_35, %bmm_164), kwargs = {})
...
# kernel path: /NHNHOME/WORKSPACE/26msit001_A/jinhyeok/loop_TTT/lact/.cache_inductor_llm/3e/c3eetnejf2p32nfs5d2fhedpd7ug5rhxyfn7vbnt3setnzqs7sxz.py
# Topologically Sorted Source Nodes: [output, setitem, setitem_1, setitem_2, setitem_3], Original ATen: [aten.zeros_like, aten.slice, aten.copy]
# Source node to ATen node mapping:
#   output => full_3, permute_2
#   setitem => copy, slice_7
...
#   %copy_3 : Tensor "bf16[32, 192, 1024][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_35, %bmm_164), kwargs = {})
#   %slice_scatter_default_3 : Tensor "bf16[32, 192, 4096][786432, 1, 192]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%slice_scatter_default_2, %copy_3, 2, 3072, 4096), kwargs = {})
#   %permute_461 : Tensor "bf16[32, 4096, 192][786432, 192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%slice_scatter_default_3, [0, 2, 1]), kwargs = {})
#   return %permute_461
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(primals_4, (32, 4096, 1), (4096, 1, 1))
        assert_size_stride(primals_5, (32, 4096, 192), (786432, 192, 1))
        assert_size_stride(primals_6, (32, 4096, 192), (786432, 192, 1))
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf12 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            buf21 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            buf23 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [ki, lr2i, lr0i, transpose_2, gate_before_act, mul_8, type_as_1, mul_9, type_as_2], Original ATen: [aten.slice, aten.transpose, aten._to_copy, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_mul_slice_transpose_0.run(primals_7, primals_10, primals_9, buf12, buf21, buf23, 6291456, stream=stream0)
            buf13 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf14 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [hidden_before_mul], Original ATen: [aten.bmm]
            extern_kernels.bmm(primals_3, buf12, out=buf14)
            buf2 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf10 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf15 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            buf3 = reinterpret_tensor(buf2, (32, 192, 1), (192, 1, 1), 0); del buf2  # reuse
            # Topologically Sorted Source Nodes: [w1_norm, bmm_2, transpose_4, dhidden], Original ATen: [aten.linalg_vector_norm, aten._to_copy, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_linalg_vector_norm_transpose_1.run(buf3, primals_2, buf10, buf15, 6144, 192, stream=stream0)
            buf16 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            extern_kernels.bmm(buf15, reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 0), out=buf16)
            buf17 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf18 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf19 = empty_strided_cuda((32, 1024, 192), (196608, 1, 1024), torch.bfloat16)
            # Topologically Sorted Source Nodes: [lr1i, silu_1, hidden, dhidden_before_mul, dgate, sigma, mul_4, sub, mul_5, add, dx, transpose_5, mul_7, type_as], Original ATen: [aten.slice, aten.silu, aten.mul, aten.sigmoid, aten.rsub, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_rsub_sigmoid_silu_slice_transpose_2.run(buf16, buf13, buf14, primals_8, buf17, buf18, buf19, 6291456, stream=stream0)
            ...
            buf25 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf26 = reinterpret_tensor(buf25, (32, 1, 1), (1, 1, 1), 0); del buf25  # reuse
            # Topologically Sorted Source Nodes: [m_i, m_i_1], Original ATen: [aten.slice, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_mean_slice_3.run(buf26, primals_4, 32, 1024, stream=stream0)
            ...
            extern_kernels.bmm(reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 0), buf19, out=buf20)
            buf27 = empty_strided_cuda((32, 1, 1, 5), (5, 160, 160, 1), torch.float32)
            buf66 = empty_strided_cuda((32, 1, 1, 5), (5, 160, 160, 1), torch.float32)
            # Topologically Sorted Source Nodes: [dw1_momentum, dw0_momentum, mul_10, dw0_1, mul_11, dw1_1, X, norm_3, X_7, norm_4], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_4.run(buf20, buf26, buf22, buf27, buf66, 160, 7373, stream=stream0)
            buf67 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf68 = reinterpret_tensor(buf67, (32, 1, 1), (1, 1, 1), 0); del buf67  # reuse
            # Topologically Sorted Source Nodes: [dw0_momentum, mul_10, dw0_1, X_7, norm_4], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf68, buf66, 32, 5, stream=stream0)
            del buf66
            buf28 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf29 = reinterpret_tensor(buf28, (32, 1, 1), (1, 1, 1), 0); del buf28  # reuse
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf29, buf27, 32, 5, stream=stream0)
            buf30 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf31 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [dw1_momentum, mul_11, dw1_1, X, add_4, X_1, transpose_6, A], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.div, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_zeros_like_6.run(buf20, buf26, buf29, buf30, buf31, 1179648, stream=stream0)
            buf32 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf30, buf31, out=buf32)
            buf33 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_14], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf32, buf33, 1179648, stream=stream0)
            buf34 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_13, B], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf35, buf32, 1179648, stream=stream0)
            buf36 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_2], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf35, buf30, out=buf36)
            buf37 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf38 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [dw1_momentum, mul_11, dw1_1, X, add_4, X_1, mul_15, X_2, transpose_7, A_1], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.div, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_zeros_like_9.run(buf20, buf26, buf29, buf36, buf37, buf38, 1179648, stream=stream0)
            buf39 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_1], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf37, buf38, out=buf39)
            buf40 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_17], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf39, buf40, 1179648, stream=stream0)
            buf41 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_16, B_1], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf42, buf39, 1179648, stream=stream0)
            buf43 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_5], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf42, buf37, out=buf43)
            buf44 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf45 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf46 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            buf69 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf70 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [dw1_momentum, dw0_momentum, mul_10, dw0_1, mul_11, dw1_1, X, add_4, X_1, mul_15, X_2, mul_18, X_3, transpose_8, A_2, X_7, add_15, X_8, transpose_11, A_5], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.div, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_zeros_like_12.run(buf20, buf26, buf29, buf36, buf43, buf22, buf68, buf44, buf45, buf46, buf69, buf70, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf71, buf72, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf74, buf71, 1179648, stream=stream0)
            buf75 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_17], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf74, buf69, out=buf75)
            buf76 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf77 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_zeros_like_9.run(buf22, buf26, buf68, buf75, buf76, buf77, 1179648, stream=stream0)
            buf78 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_6], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf76, buf77, out=buf78)
            buf79 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_32], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf78, buf79, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf81, buf78, 1179648, stream=stream0)
            buf82 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf84 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf85 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            buf105 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [dw0_momentum, mul_10, dw0_1, dw2_1, X_7, add_15, X_8, mul_30, X_9, mul_33, X_10, transpose_13, A_7, X_14], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy, aten.div, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_zeros_like_13.run(buf22, buf26, buf68, buf75, buf82, buf24, buf83, buf84, buf85, buf105, 1179648, stream=stream0)
            ...
            buf88 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_34, B_7], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf89, buf86, 1179648, stream=stream0)
            buf90 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_23], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf89, buf84, out=buf90)
            buf91 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf92 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_36, X_11, transpose_14, A_8], Original ATen: [aten.mul, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_16.run(buf83, buf90, buf91, buf92, 1179648, stream=stream0)
            buf93 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_8], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf91, buf92, out=buf93)
            buf94 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_38], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf93, buf94, 1179648, stream=stream0)
            buf95 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_37, B_8], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf96, buf93, 1179648, stream=stream0)
            buf97 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_26], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf96, buf91, out=buf97)
            buf98 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf99 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_36, X_11, mul_39, X_12, transpose_15, A_9], Original ATen: [aten.mul, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_19.run(buf83, buf90, buf97, buf98, buf99, 1179648, stream=stream0)
            buf100 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_9], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf98, buf99, out=buf100)
            buf101 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_41], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf100, buf101, 1179648, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [mul_40, B_9], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf103, buf100, 1179648, stream=stream0)
            buf104 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_29], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf103, buf98, out=buf104)
            buf0 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf1 = reinterpret_tensor(buf0, (32, 192, 1), (192, 1, 1), 0); del buf0  # reuse
            buf146 = buf83; del buf83  # reuse
            buf148 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf149 = reinterpret_tensor(buf148, (32, 192, 1), (192, 1, 1), 0); del buf148  # reuse
            buf157 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [w0_norm, mul_36, X_11, mul_39, X_12, mul_42, X_13, w0_main, norm_6, add_40, truediv_3, w0, bmm_10], Original ATen: [aten.linalg_vector_norm, aten.mul, aten.add, aten.div, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_22.run(buf1, buf146, buf149, primals_1, buf90, buf97, buf104, buf157, 6144, 192, stream=stream0)
            buf106 = buf27; del buf27  # reuse
            # Topologically Sorted Source Nodes: [norm_5], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_linalg_vector_norm_23.run(buf105, buf106, 160, 7373, stream=stream0)
            buf107 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf108 = reinterpret_tensor(buf107, (32, 1, 1), (1, 1, 1), 0); del buf107  # reuse
            # Topologically Sorted Source Nodes: [norm_5], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf108, buf106, 32, 5, stream=stream0)
            buf109 = buf97; del buf97  # reuse
            buf110 = reinterpret_tensor(buf90, (32, 192, 192), (36864, 1, 192), 0); del buf90  # reuse
            # Topologically Sorted Source Nodes: [add_26, X_15, transpose_16, A_10], Original ATen: [aten.add, aten.div, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_24.run(buf105, buf108, buf109, buf110, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf111, buf112, 1179648, stream=stream0)
            buf113 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf114, buf111, 1179648, stream=stream0)
            buf115 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_32], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf114, buf109, out=buf115)
            buf116 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf117 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_26, X_15, mul_45, X_16, transpose_17, A_11], Original ATen: [aten.add, aten.div, aten.mul, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_25.run(buf105, buf108, buf115, buf116, buf117, 1179648, stream=stream0)
            ...
            buf119 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_47], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf118, buf119, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf121, buf118, 1179648, stream=stream0)
            buf122 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_35], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf121, buf116, out=buf122)
            buf123 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf124 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_26, X_15, mul_45, X_16, mul_48, X_17, transpose_18, A_12], Original ATen: [aten.add, aten.div, aten.mul, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_26.run(buf105, buf108, buf115, buf122, buf123, buf124, 1179648, stream=stream0)
            ...
            buf126 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_50], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf125, buf126, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf128, buf125, 1179648, stream=stream0)
            buf129 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_38], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf128, buf123, out=buf129)
            buf130 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf131 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf132 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_26, X_15, mul_45, X_16, mul_48, X_17, mul_51, X_18, transpose_19, A_13], Original ATen: [aten.add, aten.div, aten.mul, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_27.run(buf105, buf108, buf115, buf122, buf129, buf130, buf131, buf132, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf133, buf134, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf136, buf133, 1179648, stream=stream0)
            buf137 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_41], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf136, buf131, out=buf137)
            buf138 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf139 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_54, X_19, transpose_20, A_14], Original ATen: [aten.mul, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf130, buf137, buf138, buf139, 1179648, stream=stream0)
            buf140 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_14], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf138, buf139, out=buf140)
            buf141 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_56], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf140, buf141, 1179648, stream=stream0)
            buf142 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf143, buf140, 1179648, stream=stream0)
            buf144 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_44], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf143, buf138, out=buf144)
            buf4 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf5 = reinterpret_tensor(buf4, (32, 192, 1), (192, 1, 1), 0); del buf4  # reuse
            buf147 = buf130; del buf130  # reuse
            buf152 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf153 = reinterpret_tensor(buf152, (32, 192, 1), (192, 1, 1), 0); del buf152  # reuse
            buf154 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [w2_norm, mul_54, X_19, mul_57, X_20, w2_main, norm_8, add_42, truediv_5, w2, h_1], Original ATen: [aten.linalg_vector_norm, aten.mul, aten.add, aten.div, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_29.run(buf5, buf147, buf153, primals_3, buf137, buf144, buf154, 6144, 192, stream=stream0)
            buf6 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [q, qi, h], Original ATen: [aten.transpose, aten.slice, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_slice_transpose_30.run(primals_5, buf6, 6291456, stream=stream0)
            buf7 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [gate, mul], Original ATen: [aten.silu, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_31.run(buf8, buf7, buf9, 6291456, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf47, buf48, 1179648, stream=stream0)
            buf49 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf50, buf47, 1179648, stream=stream0)
            ...
            buf52 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf53 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_16.run(buf44, buf51, buf52, buf53, 1179648, stream=stream0)
            buf54 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_3], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf52, buf53, out=buf54)
            buf55 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_23], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf54, buf55, 1179648, stream=stream0)
            buf56 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf57, buf54, 1179648, stream=stream0)
            buf58 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_11], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf57, buf52, out=buf58)
            buf59 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_19.run(buf44, buf51, buf58, buf59, buf60, 1179648, stream=stream0)
            buf61 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_4], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf59, buf60, out=buf61)
            buf62 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_26], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf61, buf62, 1179648, stream=stream0)
            buf63 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf64, buf61, 1179648, stream=stream0)
            ...
            buf150 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf151 = reinterpret_tensor(buf150, (32, 192, 1), (192, 1, 1), 0); del buf150  # reuse
            buf160 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf165 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_21, X_4, mul_24, X_5, mul_27, X_6, w1_main, norm_7, add_41, truediv_4, w1, bmm_11, transpose_23, dhidden_1], Original ATen: [aten.mul, aten.add, aten.linalg_vector_norm, aten.div, aten._to_copy, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_transpose_32.run(buf145, buf151, primals_2, buf51, buf58, buf65, buf3, buf160, buf165, 6144, 192, stream=stream0)
            buf155 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [q, qi_1, h_1], Original ATen: [aten.transpose, aten.slice, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_slice_transpose_33.run(primals_5, buf155, 6291456, stream=stream0)
            buf156 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf158 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [bmm_10], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf157, buf155, out=buf158)
            buf159 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [gate_1, mul_61], Original ATen: [aten.silu, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_31.run(buf158, buf156, buf159, 6291456, stream=stream0)
            ...
            buf162 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            buf171 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            buf173 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [ki_1, lr2i_1, lr0i_1, transpose_21, gate_before_act_1, mul_69, type_as_4, mul_70, type_as_5], Original ATen: [aten.slice, aten.transpose, aten._to_copy, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_mul_slice_transpose_34.run(primals_7, primals_10, primals_9, buf162, buf171, buf173, 6291456, stream=stream0)
            buf163 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf164 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [hidden_before_mul_1], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf154, buf162, out=buf164)
            buf166 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [v, vi_1, dhidden_1], Original ATen: [aten.transpose, aten.slice, aten.bmm]
            extern_kernels.bmm(buf165, reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 196608), out=buf166)
            buf167 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf168 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf169 = empty_strided_cuda((32, 1024, 192), (196608, 1, 1024), torch.bfloat16)
            # Topologically Sorted Source Nodes: [lr1i_1, silu_4, hidden_1, dhidden_before_mul_1, dgate_1, sigma_1, mul_65, sub_1, mul_66, add_43, dx_1, transpose_24, mul_68, type_as_3], Original ATen: [aten.slice, aten.silu, aten.mul, aten.sigmoid, aten.rsub, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_rsub_sigmoid_silu_slice_transpose_35.run(buf166, buf163, buf164, primals_8, buf167, buf168, buf169, 6291456, stream=stream0)
            ...
            extern_kernels.bmm(reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 196608), buf169, out=buf170)
            ...
            buf175 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf176 = reinterpret_tensor(buf175, (32, 1, 1), (1, 1, 1), 0); del buf175  # reuse
            # Topologically Sorted Source Nodes: [m_i_2, m_i_3], Original ATen: [aten.slice, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_mean_slice_36.run(buf176, primals_4, 32, 1024, stream=stream0)
            buf177 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            # Topologically Sorted Source Nodes: [dw0_momentum, mul_10, dw0_1, mul_71, dw0_3], Original ATen: [aten.zeros_like, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_zeros_like_37.run(buf172, buf22, buf26, buf176, buf177, 1179648, stream=stream0)
            buf178 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            # Topologically Sorted Source Nodes: [dw1_momentum, mul_11, dw1_1, mul_72, dw1_3], Original ATen: [aten.zeros_like, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_zeros_like_37.run(buf170, buf20, buf26, buf176, buf178, 1179648, stream=stream0)
            buf179 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf258 = buf170; del buf170  # reuse
            # Topologically Sorted Source Nodes: [dw0_momentum, mul_10, dw2_1, mul_73, dw2_3, X_35], Original ATen: [aten.zeros_like, aten.mul, aten.add, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_zeros_like_38.run(buf174, buf24, buf26, buf176, buf179, buf258, 1179648, stream=stream0)
            buf180 = buf106; del buf106  # reuse
            # Topologically Sorted Source Nodes: [X_21, norm_9], Original ATen: [aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_linalg_vector_norm_39.run(buf178, buf180, 160, 7373, stream=stream0)
            buf181 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf182 = reinterpret_tensor(buf181, (32, 1, 1), (1, 1, 1), 0); del buf181  # reuse
            # Topologically Sorted Source Nodes: [X_21, norm_9], Original ATen: [aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf182, buf180, 32, 5, stream=stream0)
            buf183 = buf174; del buf174  # reuse
            buf184 = reinterpret_tensor(buf172, (32, 192, 192), (36864, 1, 192), 0); del buf172  # reuse
            # Topologically Sorted Source Nodes: [X_21, add_47, X_22, transpose_25, A_15], Original ATen: [aten._to_copy, aten.add, aten.div, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_40.run(buf178, buf182, buf183, buf184, 1179648, stream=stream0)
            buf185 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_15], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf183, buf184, out=buf185)
            buf186 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_75], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf185, buf186, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf188, buf185, 1179648, stream=stream0)
            buf189 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_47], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf188, buf183, out=buf189)
            buf190 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf191 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [X_21, add_47, X_22, mul_76, X_23, transpose_26, A_16], Original ATen: [aten._to_copy, aten.add, aten.div, aten.mul, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_41.run(buf178, buf182, buf189, buf190, buf191, 1179648, stream=stream0)
            buf192 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_16], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf190, buf191, out=buf192)
            buf193 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf194 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf195, buf192, 1179648, stream=stream0)
            buf196 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_50], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf195, buf190, out=buf196)
            buf197 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf198 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [X_21, add_47, X_22, mul_76, X_23, mul_79, X_24, transpose_27, A_17], Original ATen: [aten._to_copy, aten.add, aten.div, aten.mul, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_42.run(buf178, buf182, buf189, buf196, buf197, buf198, 1179648, stream=stream0)
            ...
            buf200 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf201 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf202, buf199, 1179648, stream=stream0)
            ...
            buf204 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf205 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf206 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [X_21, add_47, X_22, mul_76, X_23, mul_79, X_24, mul_82, X_25, transpose_28, A_18], Original ATen: [aten._to_copy, aten.add, aten.div, aten.mul, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_43.run(buf178, buf182, buf189, buf196, buf203, buf204, buf205, buf206, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf210, buf207, 1179648, stream=stream0)
            buf211 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_56], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf210, buf205, out=buf211)
            buf212 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf213 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf204, buf211, buf212, buf213, 1179648, stream=stream0)
            buf214 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_19], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf212, buf213, out=buf214)
            buf215 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_87], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf214, buf215, 1179648, stream=stream0)
            buf216 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf217, buf214, 1179648, stream=stream0)
            buf218 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_linalg_vector_norm_39.run(buf177, buf219, 160, 7373, stream=stream0)
            buf220 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf221 = reinterpret_tensor(buf220, (32, 1, 1), (1, 1, 1), 0); del buf220  # reuse
            # Topologically Sorted Source Nodes: [X_28, norm_10], Original ATen: [aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf221, buf219, 32, 5, stream=stream0)
            buf222 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf223 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_40.run(buf177, buf221, buf222, buf223, 1179648, stream=stream0)
            buf224 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_20], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf222, buf223, out=buf224)
            buf225 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_90], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf224, buf225, 1179648, stream=stream0)
            buf226 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf227, buf224, 1179648, stream=stream0)
            ...
            buf229 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf230 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_41.run(buf177, buf221, buf228, buf229, buf230, 1179648, stream=stream0)
            buf231 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf231, buf232, 1179648, stream=stream0)
            buf233 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf234, buf231, 1179648, stream=stream0)
            buf235 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf237 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_42.run(buf177, buf221, buf228, buf235, buf236, buf237, 1179648, stream=stream0)
            ...
            buf239 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_96], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf238, buf239, 1179648, stream=stream0)
            buf240 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf241, buf238, 1179648, stream=stream0)
            buf242 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_68], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf241, buf236, out=buf242)
            buf243 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf244 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf245 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_43.run(buf177, buf221, buf228, buf235, buf242, buf243, buf244, buf245, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf246, buf247, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf249, buf246, 1179648, stream=stream0)
            buf250 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_71], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf249, buf244, out=buf250)
            buf251 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf252 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf243, buf250, buf251, buf252, 1179648, stream=stream0)
            buf253 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_24], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf251, buf252, out=buf253)
            buf254 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_102], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf253, buf254, 1179648, stream=stream0)
            buf255 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf256, buf253, 1179648, stream=stream0)
            buf257 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_red_fused_linalg_vector_norm_23.run(buf258, buf259, 160, 7373, stream=stream0)
            buf260 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf261 = reinterpret_tensor(buf260, (32, 1, 1), (1, 1, 1), 0); del buf260  # reuse
            # Topologically Sorted Source Nodes: [norm_11], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf261, buf259, 32, 5, stream=stream0)
            buf262 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf263 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_24.run(buf258, buf261, buf262, buf263, 1179648, stream=stream0)
            buf264 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_25], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf262, buf263, out=buf264)
            buf265 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_105], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf264, buf265, 1179648, stream=stream0)
            buf266 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf267, buf264, 1179648, stream=stream0)
            buf268 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_77], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf267, buf262, out=buf268)
            buf269 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf270 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_25.run(buf258, buf261, buf268, buf269, buf270, 1179648, stream=stream0)
            buf271 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_26], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf269, buf270, out=buf271)
            buf272 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_108], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf271, buf272, 1179648, stream=stream0)
            buf273 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf274, buf271, 1179648, stream=stream0)
            buf275 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_80], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf274, buf269, out=buf275)
            buf276 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf277 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_26.run(buf258, buf261, buf268, buf275, buf276, buf277, 1179648, stream=stream0)
            buf278 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_27], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf276, buf277, out=buf278)
            buf279 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_111], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf278, buf279, 1179648, stream=stream0)
            buf280 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf281, buf278, 1179648, stream=stream0)
            buf282 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf284 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_27.run(buf258, buf261, buf268, buf275, buf282, buf283, buf284, buf285, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf286, buf287, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf289, buf286, 1179648, stream=stream0)
            ...
            buf292 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf283, buf290, buf291, buf292, 1179648, stream=stream0)
            buf293 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf293, buf294, 1179648, stream=stream0)
            buf295 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf296, buf293, 1179648, stream=stream0)
            buf297 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf303 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf304 = reinterpret_tensor(buf303, (32, 192, 1), (192, 1, 1), 0); del buf303  # reuse
            buf313 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf318 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_85, X_26, mul_88, X_27, w1_main_1, norm_13, add_84, truediv_10, w1_1, bmm_20, transpose_42, dhidden_2], Original ATen: [aten.mul, aten.add, aten.linalg_vector_norm, aten.div, aten._to_copy, aten.transpose]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_transpose_44.run(buf298, buf304, buf145, buf211, buf218, buf3, buf313, buf318, 6144, 192, stream=stream0)
            buf299 = buf243; del buf243  # reuse
            buf301 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf302 = reinterpret_tensor(buf301, (32, 192, 1), (192, 1, 1), 0); del buf301  # reuse
            buf310 = buf218; del buf218  # reuse
            # Topologically Sorted Source Nodes: [mul_100, X_33, mul_103, X_34, w0_main_1, norm_12, add_83, truediv_9, w0_1, bmm_19], Original ATen: [aten.mul, aten.add, aten.linalg_vector_norm, aten.div, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_45.run(buf299, buf302, buf146, buf250, buf257, buf1, buf310, 6144, 192, stream=stream0)
            buf300 = buf283; del buf283  # reuse
            buf305 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf306 = reinterpret_tensor(buf305, (32, 192, 1), (192, 1, 1), 0); del buf305  # reuse
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_45.run(buf300, buf306, buf147, buf290, buf297, buf5, buf307, 6144, 192, stream=stream0)
            buf308 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [q, qi_2, h_2], Original ATen: [aten.transpose, aten.slice, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_slice_transpose_46.run(primals_5, buf308, 6291456, stream=stream0)
            buf309 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf311 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [bmm_19], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf310, buf308, out=buf311)
            buf312 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [gate_2, mul_122], Original ATen: [aten.silu, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_31.run(buf311, buf309, buf312, 6291456, stream=stream0)
            buf314 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [bmm_20], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf313, buf312, out=buf314)
            buf315 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            buf324 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            buf326 = empty_strided_cuda((32, 1024, 192), (196608, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [ki_2, lr2i_2, lr0i_2, transpose_40, gate_before_act_2, mul_130, type_as_7, mul_131, type_as_8], Original ATen: [aten.slice, aten.transpose, aten._to_copy, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_mul_slice_transpose_47.run(primals_7, primals_10, primals_9, buf315, buf324, buf326, 6291456, stream=stream0)
            buf316 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf317 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [hidden_before_mul_2], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf307, buf315, out=buf317)
            buf319 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [v, vi_2, dhidden_2], Original ATen: [aten.transpose, aten.slice, aten.bmm]
            extern_kernels.bmm(buf318, reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 393216), out=buf319)
            buf320 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf321 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            buf322 = empty_strided_cuda((32, 1024, 192), (196608, 1, 1024), torch.bfloat16)
            # Topologically Sorted Source Nodes: [lr1i_2, silu_7, hidden_2, dhidden_before_mul_2, dgate_2, sigma_2, mul_126, sub_2, mul_127, add_86, dx_2, transpose_43, mul_129, type_as_6], Original ATen: [aten.slice, aten.silu, aten.mul, aten.sigmoid, aten.rsub, aten.add, aten.transpose, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_rsub_sigmoid_silu_slice_transpose_48.run(buf319, buf316, buf317, primals_8, buf320, buf321, buf322, 6291456, stream=stream0)
            ...
            extern_kernels.bmm(reinterpret_tensor(primals_6, (32, 192, 1024), (786432, 1, 192), 393216), buf322, out=buf323)
            ...
            buf328 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf329 = reinterpret_tensor(buf328, (32, 1, 1), (1, 1, 1), 0); del buf328  # reuse
            # Topologically Sorted Source Nodes: [m_i_4, m_i_5], Original ATen: [aten.slice, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_mean_slice_49.run(buf329, primals_4, 32, 1024, stream=stream0)
            del primals_4
            buf330 = buf323; del buf323  # reuse
            # Topologically Sorted Source Nodes: [mul_133, dw1_5, X_42], Original ATen: [aten.mul, aten.add, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_50.run(buf330, buf178, buf329, 1179648, stream=stream0)
            buf331 = buf259; del buf259  # reuse
            # Topologically Sorted Source Nodes: [norm_15], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_linalg_vector_norm_23.run(buf330, buf331, 160, 7373, stream=stream0)
            buf332 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf333 = reinterpret_tensor(buf332, (32, 1, 1), (1, 1, 1), 0); del buf332  # reuse
            # Topologically Sorted Source Nodes: [norm_15], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf333, buf331, 32, 5, stream=stream0)
            buf334 = buf211; del buf211  # reuse
            buf335 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_24.run(buf330, buf333, buf334, buf335, 1179648, stream=stream0)
            buf336 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_30], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf334, buf335, out=buf336)
            buf337 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_136], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf336, buf337, 1179648, stream=stream0)
            buf338 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf339, buf336, 1179648, stream=stream0)
            ...
            buf341 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf342 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_25.run(buf330, buf333, buf340, buf341, buf342, 1179648, stream=stream0)
            ...
            buf344 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_139], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf343, buf344, 1179648, stream=stream0)
            buf345 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf346, buf343, 1179648, stream=stream0)
            ...
            buf348 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf349 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_26.run(buf330, buf333, buf340, buf347, buf348, buf349, 1179648, stream=stream0)
            buf350 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf350, buf351, 1179648, stream=stream0)
            buf352 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf353, buf350, 1179648, stream=stream0)
            buf354 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_98], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf353, buf348, out=buf354)
            buf355 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf356 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf357 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_27.run(buf330, buf333, buf340, buf347, buf354, buf355, buf356, buf357, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf358, buf359, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf361, buf358, 1179648, stream=stream0)
            buf362 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf364 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf355, buf362, buf363, buf364, 1179648, stream=stream0)
            buf365 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_34], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf363, buf364, out=buf365)
            buf366 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_148], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf365, buf366, 1179648, stream=stream0)
            buf367 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf368, buf365, 1179648, stream=stream0)
            buf369 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_50.run(buf370, buf177, buf329, 1179648, stream=stream0)
            buf371 = buf331; del buf331  # reuse
            # Topologically Sorted Source Nodes: [norm_16], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_linalg_vector_norm_23.run(buf370, buf371, 160, 7373, stream=stream0)
            buf372 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf373 = reinterpret_tensor(buf372, (32, 1, 1), (1, 1, 1), 0); del buf372  # reuse
            # Topologically Sorted Source Nodes: [norm_16], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf373, buf371, 32, 5, stream=stream0)
            buf374 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf375 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_24.run(buf370, buf373, buf374, buf375, 1179648, stream=stream0)
            buf376 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_35], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf374, buf375, out=buf376)
            buf377 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_151], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf376, buf377, 1179648, stream=stream0)
            buf378 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf379, buf376, 1179648, stream=stream0)
            buf380 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_107], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf379, buf374, out=buf380)
            buf381 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf382 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_25.run(buf370, buf373, buf380, buf381, buf382, 1179648, stream=stream0)
            buf383 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_36], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf381, buf382, out=buf383)
            buf384 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_154], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf383, buf384, 1179648, stream=stream0)
            buf385 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf386, buf383, 1179648, stream=stream0)
            buf387 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_110], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf386, buf381, out=buf387)
            buf388 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf389 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_26.run(buf370, buf373, buf380, buf387, buf388, buf389, 1179648, stream=stream0)
            buf390 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_37], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf388, buf389, out=buf390)
            buf391 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_157], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf390, buf391, 1179648, stream=stream0)
            buf392 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf393, buf390, 1179648, stream=stream0)
            ...
            buf395 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf396 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf397 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_27.run(buf370, buf373, buf380, buf387, buf394, buf395, buf396, buf397, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf398, buf399, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf401, buf398, 1179648, stream=stream0)
            buf402 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_116], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf401, buf396, out=buf402)
            buf403 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf404 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf395, buf402, buf403, buf404, 1179648, stream=stream0)
            buf405 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_39], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf403, buf404, out=buf405)
            buf406 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_163], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf405, buf406, 1179648, stream=stream0)
            buf407 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf408, buf405, 1179648, stream=stream0)
            buf409 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_50.run(buf410, buf179, buf329, 1179648, stream=stream0)
            buf411 = buf371; del buf371  # reuse
            # Topologically Sorted Source Nodes: [norm_17], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_linalg_vector_norm_23.run(buf410, buf411, 160, 7373, stream=stream0)
            buf412 = empty_strided_cuda((32, 1, 1), (1, 32, 32), torch.float32)
            buf413 = reinterpret_tensor(buf412, (32, 1, 1), (1, 1, 1), 0); del buf412  # reuse
            # Topologically Sorted Source Nodes: [norm_17], Original ATen: [aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_linalg_vector_norm_mul_zeros_like_5.run(buf413, buf411, 32, 5, stream=stream0)
            del buf411
            buf414 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf415 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_transpose_24.run(buf410, buf413, buf414, buf415, 1179648, stream=stream0)
            buf416 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_40], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf414, buf415, out=buf416)
            buf417 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_166], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_7.run(buf416, buf417, 1179648, stream=stream0)
            buf418 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf419, buf416, 1179648, stream=stream0)
            buf420 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_122], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf419, buf414, out=buf420)
            buf421 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf422 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_25.run(buf410, buf413, buf420, buf421, buf422, 1179648, stream=stream0)
            buf423 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_41], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf421, buf422, out=buf423)
            buf424 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_169], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_10.run(buf423, buf424, 1179648, stream=stream0)
            buf425 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf426, buf423, 1179648, stream=stream0)
            buf427 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_125], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf426, buf421, out=buf427)
            buf428 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf429 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_26.run(buf410, buf413, buf420, buf427, buf428, buf429, 1179648, stream=stream0)
            buf430 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_42], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf428, buf429, out=buf430)
            buf431 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_172], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_14.run(buf430, buf431, 1179648, stream=stream0)
            buf432 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_15.run(buf433, buf430, 1179648, stream=stream0)
            buf434 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_128], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf433, buf428, out=buf434)
            buf435 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.float32)
            buf436 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf437 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_mul_transpose_27.run(buf410, buf413, buf420, buf427, buf434, buf435, buf436, buf437, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_17.run(buf438, buf439, 1179648, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_18.run(buf441, buf438, 1179648, stream=stream0)
            buf442 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_131], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf441, buf436, out=buf442)
            buf443 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            buf444 = empty_strided_cuda((32, 192, 192), (36864, 1, 192), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_mul_transpose_28.run(buf435, buf442, buf443, buf444, 1179648, stream=stream0)
            buf445 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [A_44], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf443, buf444, out=buf445)
            buf446 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_178], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_20.run(buf445, buf446, 1179648, stream=stream0)
            buf447 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_21.run(buf448, buf445, 1179648, stream=stream0)
            buf449 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            buf455 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf456 = reinterpret_tensor(buf455, (32, 192, 1), (192, 1, 1), 0); del buf455  # reuse
            buf465 = empty_strided_cuda((32, 192, 192), (36864, 192, 1), torch.bfloat16)
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_45.run(buf450, buf456, buf298, buf362, buf369, buf3, buf465, 6144, 192, stream=stream0)
            del buf362
            buf451 = buf395; del buf395  # reuse
            buf453 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf454 = reinterpret_tensor(buf453, (32, 192, 1), (192, 1, 1), 0); del buf453  # reuse
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_45.run(buf451, buf454, buf299, buf402, buf409, buf1, buf462, 6144, 192, stream=stream0)
            del buf402
            buf452 = buf435; del buf435  # reuse
            buf457 = empty_strided_cuda((32, 192, 1), (192, 1, 6144), torch.float32)
            buf458 = reinterpret_tensor(buf457, (32, 192, 1), (192, 1, 1), 0); del buf457  # reuse
            ...
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_div_linalg_vector_norm_mul_45.run(buf452, buf458, buf300, buf442, buf449, buf5, buf459, 6144, 192, stream=stream0)
            del buf442
            del buf449
            buf460 = empty_strided_cuda((32, 192, 1024), (196608, 1, 192), torch.bfloat16)
            # Topologically Sorted Source Nodes: [q, qi_3, h_3], Original ATen: [aten.transpose, aten.slice, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_slice_transpose_51.run(primals_5, buf460, 6291456, stream=stream0)
            del primals_5
            buf461 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            ...
            buf463 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [bmm_28], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf462, buf460, out=buf463)
            buf464 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [gate_3, mul_183], Original ATen: [aten.silu, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_31.run(buf463, buf461, buf464, 6291456, stream=stream0)
            buf466 = empty_strided_cuda((32, 192, 1024), (196608, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [bmm_29], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf465, buf464, out=buf466)
            buf467 = empty_strided_cuda((32, 192, 4096), (786432, 4096, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [output, setitem, setitem_1, setitem_2, setitem_3], Original ATen: [aten.zeros_like, aten.slice, aten.copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused_copy_slice_zeros_like_52.run(buf466, buf314, buf161, buf11, buf467, 25165824, stream=stream0)
            del buf11
            del buf161
            del buf314
            del buf466
            buf468 = empty_strided_cuda((32, 4096, 192), (786432, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [output, setitem, setitem_1, setitem_2, setitem_3], Original ATen: [aten.zeros_like, aten.slice, aten.copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused_copy_slice_zeros_like_53.run(buf467, buf468, 131072, 192, stream=stream0)
            del buf467
        return (buf468, primals_1, primals_2, primals_3, primals_7, primals_8, primals_9, primals_10, buf1, buf3, buf5, buf7, buf8, buf13, buf14, buf16, buf20, buf22, buf24, buf26, buf29, buf68, buf105, buf108, buf145, buf146, buf147, buf149, buf151, buf153, buf156, buf158, buf163, buf164, buf166, buf176, buf177, buf178, buf179, buf182, buf221, buf258, buf261, buf298, buf299, buf300, buf302, buf304, buf306, buf309, buf311, buf316, buf317, buf319, buf329, buf330, buf333, buf370, buf373, buf410, buf413, buf450, buf451, buf452, buf454, buf456, buf458, buf461, buf463, reinterpret_tensor(buf465, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf464, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf462, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf460, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf459, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf448, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf443, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf446, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf445, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf444, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf441, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf436, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf439, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf438, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf437, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf433, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf428, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf431, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf430, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf429, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf426, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf421, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf424, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf423, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf422, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf419, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf414, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf417, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf416, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf415, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf408, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf403, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf406, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf405, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf404, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf401, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf396, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf399, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf398, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf397, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf393, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf388, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf391, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf390, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf389, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf386, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf381, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf384, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf383, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf382, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf379, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf374, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf377, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf376, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf375, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf368, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf363, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf366, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf365, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf364, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf361, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf356, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf359, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf358, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf357, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf353, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf348, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf351, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf350, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf349, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf346, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf341, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf344, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf343, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf342, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf339, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf334, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf337, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf336, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf335, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf320, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf326, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(buf321, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf324, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(primals_6, (32, 1024, 192), (786432, 192, 1), 393216), reinterpret_tensor(buf322, (32, 192, 1024), (196608, 1024, 1), 0), reinterpret_tensor(buf318, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf307, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf315, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf310, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf313, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf312, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf308, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf296, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf291, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf294, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf293, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf292, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf289, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf284, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf287, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf286, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf285, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf281, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf276, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf279, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf278, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf277, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf274, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf269, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf272, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf271, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf270, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf267, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf262, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf265, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf264, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf263, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf256, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf251, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf254, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf253, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf252, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf249, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf244, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf247, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf246, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf245, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf241, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf236, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf239, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf238, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf237, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf234, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf229, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf232, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf231, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf230, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf227, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf222, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf225, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf224, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf223, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf217, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf212, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf215, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf214, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf213, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf210, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf205, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf208, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf207, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf206, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf202, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf197, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf200, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf199, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf198, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf195, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf190, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf193, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf192, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf191, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf188, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf183, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf186, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf185, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf184, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf167, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf173, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(buf168, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf171, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(primals_6, (32, 1024, 192), (786432, 192, 1), 196608), reinterpret_tensor(buf169, (32, 192, 1024), (196608, 1024, 1), 0), reinterpret_tensor(buf165, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf154, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf162, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf157, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf160, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf159, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf155, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf143, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf138, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf141, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf140, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf139, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf136, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf131, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf134, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf133, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf132, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf128, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf123, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf126, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf125, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf124, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf121, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf116, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf119, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf118, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf117, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf114, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf109, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf112, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf111, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf110, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf103, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf98, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf101, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf100, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf99, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf96, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf91, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf94, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf93, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf92, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf89, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf84, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf87, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf86, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf85, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf81, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf76, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf79, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf78, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf77, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf74, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf69, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf72, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf71, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf70, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf64, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf59, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf62, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf61, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf60, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf57, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf52, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf55, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf54, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf53, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf50, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf45, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf48, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf47, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf46, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf42, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf37, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf40, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf39, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf38, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf35, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf30, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf33, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf32, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf31, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf17, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf23, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(buf18, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf21, (32, 192, 1024), (196608, 1, 192), 0), reinterpret_tensor(primals_6, (32, 1024, 192), (786432, 192, 1), 0), reinterpret_tensor(buf19, (32, 192, 1024), (196608, 1024, 1), 0), reinterpret_tensor(buf15, (32, 192, 192), (36864, 192, 1), 0), reinterpret_tensor(buf12, (32, 1024, 192), (196608, 192, 1), 0), reinterpret_tensor(buf10, (32, 192, 192), (36864, 1, 192), 0), reinterpret_tensor(buf9, (32, 1024, 192), (196608, 1, 1024), 0), reinterpret_tensor(buf6, (32, 1024, 192), (196608, 192, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_4 = rand_strided((32, 4096, 1), (4096, 1, 1), device='cuda:0', dtype=torch.float32)
    primals_5 = rand_strided((32, 4096, 192), (786432, 192, 1), device='cuda:0', dtype=torch.float32)
    primals_6 = rand_strided((32, 4096, 192), (786432, 192, 1), device='cuda:0', dtype=torch.bfloat16)
