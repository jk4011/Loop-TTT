...
class DinoModelWrapper(nn.Module):
    ...
    def __init__(self, dino_model="dinov2_vitb14_reg", device="cpu", grid_size=(16, 16), min_depth=0.001, max_depth=10.0):
        super().__init__()
        ...
        self.classifier = PatchDepthClassifier(
            num_bins=256,
            grid_size=grid_size,   # 256 patch tokens from 224×224 @ patch size 14
            upsample_factor=4,
            min_depth=min_depth,
            max_depth=max_depth,
