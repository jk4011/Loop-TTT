...
try:
    ...
    assert_tensors_similar = None  # only needed for test_sparse_mla_bwd
...
def ref_sparse_mla_bwd_interface(q, kv, o, do, indices, lse, sm_scale=None, is_casual=True):
    try:
        from sparse_mla_fwd import ref_sparse_mla_fwd_interface  # tilelang example dir
    except ImportError:
        from .sparse_mla_fwd import ref_sparse_mla_fwd_interface  # package import
