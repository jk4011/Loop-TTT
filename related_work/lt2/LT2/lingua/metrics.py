...
class MetricLogger:
    ...
    def open(self):
        ...
        if (
            ...
            # Define custom x-axis for plotting loss vs tokens
            wandb.define_metric("optim/total_tokens")
            wandb.define_metric("loss/out_vs_tokens", step_metric="optim/total_tokens")
