...
class StoolArgs:
    ...
    script: str = "apps.LT2.train"  # The script to run.
    ...
    mem: str = "200GB"  # The amount of memory to allocate.
    ...
    time: int = 1440  # The time limit of the job (in minutes).
    account: str = ""
    qos: str = ""
...
export HF_DATASETS_CACHE=${{HF_DATASETS_CACHE:-<YOUR_HF_DATASETS_CACHE>}}
...
if __name__ == "__main__":
    ...
    """
    print("Starting stool...")
    args = OmegaConf.from_cli()
    print(f"Loading config from {args.config}...")
    args.config = OmegaConf.load(args.config)
    print(f"Converting to dataclass...")
