...
| 구성 (16M, s95) | ppl | vs naive(74.45) | vs 3다이얼(59.14) |
|---|---|---|---|
| naive loop 2×4 | 74.45 | — | — |
| 3다이얼 (기존 최고) | 59.14 | −15.31 | — |
| **inner_only** (inner만, 다이얼 없음) | **57.68** | −16.77 | **−1.46** |
| **3다이얼 + inner full** (affine_inner) | **55.20** | **−19.25** | **−3.94** |
| 3다이얼 + TTT-이음새 inner만 (innerttt) | 59.45 | −15.00 | +0.31 |
